...
var BarResponsive = React.createClass({
	componentDidMount: function() {
		...
		this.refs.barResponsive.addEventListener('click', this.open, false);
	},
	bindOpen: function() {
		// this.getDOMNode().addEventListener('click', this.open , false);
		this.refs.barResponsive.addEventListener('click', this.open, false);
	...
	bindClose: function() {
		...
		this.refs.barResponsive.removeEventListener('click', this.open, false);
	},
	open: function() {
		if (ruler.getScrollY() <
	...
	render: function() {
		return (
			<div className="barResponsive" ref="barResponsive">
				MENU
			</div>
		);
	}
