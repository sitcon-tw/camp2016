var paywayParagraphs = [
	...
	"$ <span class='left'>\
		...
		<span class='right'>\
			<a id='linkHelpFinancial' target='_blank' href=''>\
				報名費用補助辦法\
			</a>\
		</span>",
	"$ <span class='left'>\
	...
	"$ <span> </span>",
	"$ 本次營隊報名採用KKTIX <a id='linkDetailProc' target='_blank' href=''>詳細報名流程</a>",
	"$ <div class='registBlock'>\
			<a target='_blank' class='regist1' href=''>\
				<p>我要報名</p>\
				<p>08.02 ~ 08.05</p>\
			</a>\
		</div>",
	...
	"$ <ol>\
			...
			<li>可以在此下載<a href='' target='_blank'>報名簡章</a>任何相關問題請寄信至 <a href='mailto:ask@sitcon.camp'>ask@sitcon.camp</a> ，我們將盡快與您連絡。</li>\
		</ol>",
];
